package Rankine
  ...
  connect(staticHX1.cold_outlet, sinkPressure.flange) annotation(
        Line(points = {{-4, 12}, {-2, 12}, {-2, 26}, {36, 26}}, color = {0, 0, 255}));
  connect(sinkPressure1.flange, staticHX1.hot_outlet) annotation(
        Line(points = {{-58, -14}, {-16, -14}, {-16, -6}}, color = {0, 0, 255}));
  connect(sourceMassFlow1.flange, staticHX1.hot_inlet) annotation(
    ...
    model Test_QuasiStaticHX
      ...
      ThermoPower.Water.SourceMassFlow sourceMassFlow1(T = 365, h = 2804772, use_T = false, w0 = 0.01) annotation(
        Placement(visible = true, transformation(origin = {54, -16}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
      ThermoPower.Water.SourceMassFlow sourceMassFlow(h = 250000, use_in_w0 = true, w0 = 0.5) annotation(
        Placement(visible = true, transformation(origin = {-70, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      inner ThermoPower.System system annotation(
        Placement(visible = true, transformation(origin = {84, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ThermoPower.Water.SinkPressure sinkPressure(h = 0) annotation(
      ...
      Components.StaticHX staticHX annotation(
    ...
    equation
      ...
      connect(sourceMassFlow.flange, staticHX.cold_inlet) annotation(
        Line(points = {{-60, 26}, {-44, 26}, {-44, 10}, {-24, 10}}, color = {0, 0, 255}));
      connect(sinkPressure1.flange, staticHX.hot_outlet) annotation(
        Line(points = {{-58, -14}, {-44, -14}, {-44, -2}, {-24, -2}}, color = {0, 0, 255}));
      connect(sinkPressure.flange, staticHX.cold_outlet) annotation(
        Line(points = {{36, 26}, {16, 26}, {16, 10}, {-4, 10}}, color = {0, 0, 255}));
      connect(sourceMassFlow1.flange, staticHX.hot_inlet) annotation(
        Line(points = {{44, -16}, {16, -16}, {16, -2}, {-4, -2}}, color = {0, 0, 255}));
    end Test_QuasiStaticHX;

    package Test_DynamicHX_Data
      model Test_DynamicHX_01
        Modelica.Blocks.Sources.Ramp ramp(duration = 2, height = 10, offset = 0.5, startTime = 10) annotation(
          Placement(visible = true, transformation(origin = {-112, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ThermoPower.Water.SinkPressure sinkPressure1 annotation(
          Placement(visible = true, transformation(origin = {-68, -14}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
        ThermoPower.Water.SourceMassFlow sourceMassFlow(h = 150000, use_in_w0 = true, w0 = 0.5) annotation(
          Placement(visible = true, transformation(origin = {-70, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ThermoPower.Water.SinkPressure sinkPressure annotation(
          Placement(visible = true, transformation(origin = {46, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ThermoPower.Water.SourceMassFlow sourceMassFlow1(h = 2804772, use_T = false, w0 = 0.5) annotation(
          Placement(visible = true, transformation(origin = {54, -16}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
        inner ThermoPower.System system annotation(
          Placement(visible = true, transformation(origin = {86, 86}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Components.DynamicHX dynamicHX(Q_nom = 1, h_t = 8000, n = 50, use_q_nom = true) annotation(
          Placement(visible = true, transformation(origin = {-10, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(ramp.y, sourceMassFlow.in_w0) annotation(
          Line(points = {{-100, 54}, {-74, 54}, {-74, 32}}, color = {0, 0, 127}));
      ...
      end Test_DynamicHX_01;

      model Test_DynamicHX_02
        Modelica.Blocks.Sources.Ramp ramp(duration = 2, height = 10, offset = 0.5, startTime = 10) annotation(
          Placement(visible = true, transformation(origin = {-112, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ThermoPower.Water.SinkPressure sinkPressure1 annotation(
          Placement(visible = true, transformation(origin = {-68, -14}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
        ...
        ThermoPower.Water.SinkPressure sinkPressure annotation(
          Placement(visible = true, transformation(origin = {46, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ThermoPower.Water.SourceMassFlow sourceMassFlow1(h = 2804772, use_T = false, w0 = 0.01) annotation(
          Placement(visible = true, transformation(origin = {54, -16}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
        inner ThermoPower.System system annotation(
          Placement(visible = true, transformation(origin = {86, 86}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Components.DynamicHX dynamicHX(Q_nom = 1, h_t = 4000, n = 50, use_q_nom = true) annotation(
          Placement(visible = true, transformation(origin = {-10, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(ramp.y, sourceMassFlow.in_w0) annotation(
          Line(points = {{-100, 54}, {-74, 54}, {-74, 32}}, color = {0, 0, 127}));
        ...
        connect(sourceMassFlow1.flange, dynamicHX.hot_inlet) annotation(
          Line(points = {{44, -16}, {18, -16}, {18, -2}, {0, -2}}, color = {0, 0, 255}));
      end Test_DynamicHX_02;
    end Test_DynamicHX_Data;
  end Tests;
...
//Temperature difference at the inlet and outlet
  ...
  package Components
    model StaticHX
      ...
      SI.Pressure p_hot "Hot side Pressure";
      SI.Pressure p_cold "Cold side pressure";
...
//Pressure at the flanges
    ...
    model DynamicHX
      ...
      SI.Power Qt[n] "Heat transfer at slice i";
      //New addition
      parameter Boolean use_q_nom = false;
      parameter SI.Power Q_nom = 10;
      //End of new addition
      Real x_h[n] "Hot side vapour quality";
      Real x_c[n] "Hot side vapour quality";
      Medium.MassFlowRate wh "Hot side mass flow rate";
...
//new addition
//Heat transfer Q_i ( the second value in homotopy is an approximation for dT_ave )
      if use_q_nom == false then
        Qt[1:n] = 2 * pi * r * dx * h_t * homotopy(Th[1:n] - Tc[1:n], (Th[n] - Tc[1]) / 2);
      else
        Qt[1:n] = 2 * pi * r * dx * h_t * homotopy(Th[1:n] - Tc[1:n], Q_nom);
      end if;
//end of new addition
//Energy conservation for cold fluid
      for i in 2:n loop
...
//Flange equations
      ...
      annotation(
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian -d=bltdump",
        __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"),
        Icon(graphics = {Text(origin = {-1, -68}, extent = {{-39, 12}, {39, -12}}, textString = "hot"), Bitmap(origin = {71, -1}, extent = {{-239, 101}, {95, -101}}, imageSource = ""), Text(origin = {-2, 66}, extent = {{-42, 12}, {42, -12}}, textString = "cold"), Rectangle(origin = {57, -66}, fillPattern = FillPattern.Solid, extent = {{-15, 12}, {15, -12}}), Rectangle(origin = {-65, 61}, fillPattern = FillPattern.Solid, extent = {{-15, 9}, {15, -9}})}));
    end DynamicHX;
