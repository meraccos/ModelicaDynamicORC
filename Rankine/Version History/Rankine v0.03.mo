package Rankine
  ...
  //Boundary conditions
    ...
    partial model BaseHX
      ...
      parameter SI.Length L = 0.8 "Length of the HX" annotation (Dialog(group="Dimension"));
      parameter SI.Length W = 0.3 "Width of the HX" annotation (Dialog(group="Dimension")); 
      parameter SI.Length D = N * (t_f+ t_w)  "Depth of the HX, dependent" annotation (Dialog(group="Dimension")); 
      parameter SI.Length t_f = 0.0022 "Width of the HX" annotation (Dialog(group="Dimension")); 
      parameter SI.Length t_w = 0.0005 "Width of the HX" annotation (Dialog(group="Dimension"));     
      final parameter SI.Length dx = L / n annotation (Dialog(group="Dimension"));
      final parameter SI.Volume dV_f = W * dx * t_f annotation (Dialog(group="Dimension")); 
      final parameter SI.Volume dV_w = W * dx * t_w annotation (Dialog(group="Dimension"));    
      ...
      final parameter SI.Temperature Tc_in = Medium.temperature_ph(p_cold_nom, hc_in_nom)
      annotation (Dialog(tab="Initialization"));
      final parameter SI.Temperature Th_in = Medium.temperature_ph(p_hot_nom, hh_in_nom)
      annotation (Dialog(tab="Initialization")); 
